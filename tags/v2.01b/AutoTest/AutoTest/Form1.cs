...
*/
        ...
        {
            string my_string = "";
            string compare_string = "UART2Init";
            ...
            while (jbutton1 == true)
            {
                while (LogQueue1.Count > 0)
                {
                    ...
                    if ((temp_char == '\n'))
                    {
                        string[] ewords = my_string.Split(new string[] { compare_string }, StringSplitOptions.RemoveEmptyEntries);
                        if (Convert.ToInt32(ewords.Length - 1) >= 1)
                        {
                            compare_number = compare_number + (ewords.Length - 1);
                        }
                        my_string = "";
                    }
                    else
                    ...
                    Console.WriteLine("compare_number1: " + compare_number);
                }
            }
        }
        ...
        {
            string my_string = "";
            string compare_string = "stop_machine_cpu_stop";
            int compare_number = 0;
            ...
            while (jbutton1 == true)
            {
                while (LogQueue2.Count > 0)
                {
                    ...
                    Console.WriteLine("compare_number2: " + compare_number);
                }
            }
        }
...
*/
        ...
        private void StartBtn_Click(object sender, EventArgs e)
        {
            ...
            if (status == true)
            {
                ...
                Thread oThreadLog1B = new Thread(new ThreadStart(MyLog1Camd));
                Thread oThreadLog2B = new Thread(new ThreadStart(MyLog2Camd));
...
*/
                    ...
                    {
                        iniRs232(); //啟動RS232
                        //oThreadLog1B.IsBackground = true;
                        //oThreadLog1B.Start();
                    }
                    if (ini12.INIRead(Application.StartupPath + "\\Config.ini", "ExtComport", "value", "") == "1")
                    {
                        ExtiniRs232();
                        //oThreadLog2B.IsBackground = true;
                        //oThreadLog2B.Start();
                    }
                    jbutton1 = true;
                    SettingBtn.Enabled = false;
