...
namespace AutoTest
{
    public partial class Setting : Form
    {
        ...
        public void OkBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                ini12.INIWrite(sPath, "camera", "UserDefine", "0");
            ...
            else
            {
                if (VIDTextBox.Text == "")
                {
                    ...
                    VIDTextBox.BackColor = System.Drawing.Color.Yellow;
                    Global.FormSetting = false;
                }
                ...
                {
                    ini12.INIWrite(sPath, "camera", "UserDefine", "1");
                    VIDTextBox.BackColor = default(Color);
                    ini12.INIWrite(sPath, "camera", "VID", VIDTextBox.Text.Trim());
                    PIDTextBox.BackColor = default(Color);
