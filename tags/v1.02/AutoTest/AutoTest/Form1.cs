    ...
    public partial class Form1 : Form
    {
        ...
        public void readSch()
        {
            ...
            if (TextLine != "")
            {
                ...
                if (j == 8)
                {
                    MessageBox.Show("This csv file is older version. If you want to use it, it will not operate properly resulting in delay time.");
                }
                if (j != 8 && j != 10)
                {
                    MessageBox.Show("This csv file format error, please recheck csv file format.");
                    button1.Enabled = false;
                }
            }
        }
        ...
        { // 執行緒
                    ...
                    for (int i = 0; i < this.DataGridView1.Rows.Count - 1; i++)
                    {
                        ...
                        if (this.DataGridView1.Rows[i].Cells[0].Value.ToString() == "_cmd")
                        {
                            ...
                            if (DataGridView1.Rows[i].Cells[3].Value.ToString() == "_shot")
                            {
                                ...
                                {
                                    MessageBox.Show("This config file can't open camera, please recheck setting.");
                                }
                        ...
                        else
                        {
                            ...
                            {
                                MessageBox.Show("This config file can't open redrat, please recheck setting.");
                            }
                        }
            ...
            //結束
            MessageBox.Show("Auto Test finished!");
        ...
        protected void savevideo()
        {
            ...
            {
                Vread = false;
                MessageBox.Show("Check the HD Capacity!");
            }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (jbutton1 == true)
            {
                ...
                MessageBox.Show("Waiting for Loop finished");
            }
            else
            {
                if (ini12.INIRead(Application.StartupPath + "\\Config.ini", "IR Device", "value", "") == "2")
