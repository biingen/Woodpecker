...
namespace AutoTest
{
    class SpiderCamera
    {
        ...
        {
            //Form1.button_Start.Enabled = false;
        ...
        private void CaptureDone(System.Drawing.Bitmap e)
        {
            ...
            Form1.pictureBox4.Image = newBitmap;
            ...
            if (ini12.INIRead(MainSettingPath, "Record", "CompareChoose", "") == "1")
            {
                ...
                */
                Form1.pictureBox4.Image.Save(compareFile);
            ...
            //照片印上現在步驟//
            if (Form1.DataGridView_Schedule.Rows[Global.Schedule_Step].Cells[0].Value.ToString() == "_shot")
            {
            ...
            //照片印上現在時間//
            bitMap_g.DrawString(DateTime.Now(),
                                Font,
                                FontColor,
            ...
            Form1.pictureBox4.Image.Save(t);
            //<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<

            Form1.button_Start.Enabled = true;
        }
        #endregion
