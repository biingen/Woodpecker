...
namespace AutoTest
{
    public partial class FormSchedule : Form
    {
        ...
        public FormSchedule()
        {
            ...
            LoopBox1.Text = ini12.INIRead(sPath, "Schedule1", "Loop", "");

            string differentnum = ini12.INIRead(sPath, "Record", "CompareDifferent", "");
            if (differentnum == "100")
            {
            ...
            if (ini12.INIRead(sPath, "Record", "EachVideo", "") != "")
            {
                if (int.Parse(ini12.INIRead(sPath, "Record", "EachVideo", "")) == 1)
            ...
            {
                ini12.INIWrite(sPath, "Record", "EachVideo", "0");
            }

            if (ini12.INIRead(sPath, "Schedule2", "Exist", "") != "")
            {
                if (int.Parse(ini12.INIRead(sPath, "Schedule2", "Exist", "")) == 1)
                {
                    SchCheckBox2.Checked = true;
                    SchBox2.Text = ini12.INIRead(sPath, "Schedule2", "Path", "");
                    LoopBox2.Text = ini12.INIRead(sPath, "Schedule2", "Loop", "");
                }
                else
                {
            ...
            {
                ini12.INIWrite(sPath, "Schedule2", "Exist", "0");
                ini12.INIWrite(sPath, "Schedule2", "Loop", "0");
                SchCheckBox2.Checked = false;
                LoadSchBtn2.Enabled = false;
                SchBox2.Enabled = false;
                LoopBox2.Enabled = false;
            ...
            if (ini12.INIRead(sPath, "Schedule3", "Exist", "") != "")
            {
                if (int.Parse(ini12.INIRead(sPath, "Schedule3", "Exist", "")) == 1)
                {
                    SchCheckBox3.Checked = true;
                    SchBox3.Text = ini12.INIRead(sPath, "Schedule3", "Path", "");
                    LoopBox3.Text = ini12.INIRead(sPath, "Schedule3", "Loop", "");
                }
                else
                {
            ...
            {
                ini12.INIWrite(sPath, "Schedule3", "Exist", "0");
                ini12.INIWrite(sPath, "Schedule3", "Loop", "0");
                SchCheckBox3.Checked = false;
                LoadSchBtn3.Enabled = false;
                SchBox3.Enabled = false;
                LoopBox3.Enabled = false;
            ...
            if (ini12.INIRead(sPath, "Schedule4", "Exist", "") != "")
            {
                if (int.Parse(ini12.INIRead(sPath, "Schedule4", "Exist", "")) == 1)
                {
                    SchCheckBox4.Checked = true;
                    SchBox4.Text = ini12.INIRead(sPath, "Schedule4", "Path", "");
                    LoopBox4.Text = ini12.INIRead(sPath, "Schedule4", "Loop", "");
                }
                else
                {
            ...
            {
                ini12.INIWrite(sPath, "Schedule4", "Exist", "0");
                ini12.INIWrite(sPath, "Schedule4", "Loop", "0");
                SchCheckBox4.Checked = false;
                LoadSchBtn4.Enabled = false;
                SchBox4.Enabled = false;
                LoopBox4.Enabled = false;
            ...
            if (ini12.INIRead(sPath, "Schedule5", "Exist", "") != "")
            {
                if (int.Parse(ini12.INIRead(sPath, "Schedule5", "Exist", "")) == 1)
                {
                    SchCheckBox5.Checked = true;
                    SchBox5.Text = ini12.INIRead(sPath, "Schedule5", "Path", "");
                    LoopBox5.Text = ini12.INIRead(sPath, "Schedule5", "Loop", "");
                }
                else
                {
            ...
            {
                ini12.INIWrite(sPath, "Schedule5", "Exist", "0");
                ini12.INIWrite(sPath, "Schedule5", "Loop", "0");
                SchCheckBox5.Checked = false;
                LoadSchBtn5.Enabled = false;
                SchBox5.Enabled = false;
                LoopBox5.Enabled = false;
            ...
            if (ini12.INIRead(sPath, "Record", "CompareChoose", "") != "")
            {
                if (int.Parse(ini12.INIRead(sPath, "Record", "CompareChoose", "")) == 1)
                {
            ...
            {
                ini12.INIWrite(sPath, "Record", "CompareChoose", "0");
                CompareCheckBox.Checked = false;
                DifferenceBox.Enabled = false;
            }

            #region Timer
            if (ini12.INIRead(sPath, "Schedule1", "OnTimeStart", "") != "")
            {
                if (int.Parse(ini12.INIRead(sPath, "Schedule1", "OnTimeStart", "")) == 1)
                {
            ...
            if (ini12.INIRead(sPath, "Schedule2", "OnTimeStart", "") != "")
            {
                if (int.Parse(ini12.INIRead(sPath, "Schedule2", "OnTimeStart", "")) == 1)
                {
            ...
            if (ini12.INIRead(sPath, "Schedule3", "OnTimeStart", "") != "")
            {

                if (int.Parse(ini12.INIRead(sPath, "Schedule3", "OnTimeStart", "")) == 1)
                {
            ...
            if (ini12.INIRead(sPath, "Schedule4", "OnTimeStart", "") != "")
            {

                if (int.Parse(ini12.INIRead(sPath, "Schedule4", "OnTimeStart", "")) == 1)
                {
            ...
            if (ini12.INIRead(sPath, "Schedule5", "OnTimeStart", "") != "")
            {

                if (int.Parse(ini12.INIRead(sPath, "Schedule5", "OnTimeStart", "")) == 1)
                {
            ...
            {
                ini12.INIWrite(sPath, "Schedule5", "OnTimeStart", "0");
                checkBoxTimer5.Checked = false;
                dateTimePickerSch5.Enabled = false;
            }
            #endregion
        ...
        private void RecVideo_CheckedChanged(object sender, EventArgs e)       //勾選此CheckBox打開測試後錄影功能
        {
            if (RecVideo.Checked == true)
                ini12.INIWrite(sPath, "Record", "EachVideo", "1");        // 寫入Each record video啟動
            else
                ini12.INIWrite(sPath, "Record", "EachVideo", "0");        // 寫入Each record video關閉
        }
        ...
        public void SaveSchBtn_Click(object sender, EventArgs e)
        {
            if (System.IO.File.Exists(SchBox1.Text.Trim()))
            {
                ...
                ini12.INIWrite(sPath, "Schedule1", "Exist", "1");
                ...
                if (string.IsNullOrEmpty(LoopBox1.Text) || LoopBox1.Text == "0")
                {
                    ...
                    ini12.INIWrite(sPath, "Schedule1", "Loop", LoopBox1.Text.Trim());
            }
            else
            {
            ...
            if (SchCheckBox2.Checked == true)
            {
                if (System.IO.File.Exists(SchBox2.Text.Trim()) == true)
                {
                    ...
                    ini12.INIWrite(sPath, "Schedule2", "Exist", "1");
                ...
                else
                {
                    ...
                    ini12.INIWrite(sPath, "Schedule2", "Loop", LoopBox2.Text.Trim());
                }
            }
            ...
            if (SchCheckBox3.Checked == true)
            {
                if (System.IO.File.Exists(SchBox3.Text.Trim()) == true)
                {
                    ...
                    ini12.INIWrite(sPath, "Schedule3", "Exist", "1");
                ...
                else
                {
                    ...
                    ini12.INIWrite(sPath, "Schedule3", "Loop", LoopBox3.Text.Trim());
                }
            }
            ...
            if (SchCheckBox4.Checked == true)
            {
                if (System.IO.File.Exists(SchBox4.Text.Trim()) == true)
                {
                    ...
                    ini12.INIWrite(sPath, "Schedule4", "Exist", "1");
                ...
                else
                {
                    ...
                    ini12.INIWrite(sPath, "Schedule4", "Loop", LoopBox4.Text.Trim());
                }
            }
            ...
            if (SchCheckBox5.Checked == true)
            {
                if (System.IO.File.Exists(SchBox5.Text.Trim()) == true)
                {
                    ...
                    ini12.INIWrite(sPath, "Schedule5", "Exist", "1");
                ...
                else
                {
                    ...
                    ini12.INIWrite(sPath, "Schedule5", "Loop", LoopBox5.Text.Trim());
                }
            }
            ...
            {
                for (int i = 1; i < 6; i++)
                    Global.Total_Loop += int.Parse(ini12.INIRead(sPath, "Schedule" + i, "Loop", ""));
            }
            ...
            #region Schedule2偵錯
            if (ini12.INIRead(sPath, "Schedule2", "OnTimeStart", "") == "1")
            {
                if (ini12.INIRead(sPath, "Schedule1", "OnTimeStart", "") == "1" && DateTime.Compare(dt1, dt2) > 0)
                {
            ...
            #endregion
            #region Schedule3偵錯
            if (ini12.INIRead(sPath, "Schedule3", "OnTimeStart", "") == "1")
            {
                if (ini12.INIRead(sPath, "Schedule1", "OnTimeStart", "") == "1" && DateTime.Compare(dt1, dt3) > 0)
                {
                    checkBoxTimer3.BackColor = System.Drawing.Color.DarkMagenta;
                    SavedLabel.Text = "Schedule3 Timer Error !";
                    Global.FormSchedule = false;
                }
                else if (ini12.INIRead(sPath, "Schedule2", "OnTimeStart", "") == "1" && DateTime.Compare(dt2, dt3) > 0)
                {
                    checkBoxTimer3.BackColor = System.Drawing.Color.DarkMagenta;
                    SavedLabel.Text = "Schedule3 Timer Error !";
                    Global.FormSchedule = false;
            ...
            #endregion
            #region Schedule4偵錯
            if (ini12.INIRead(sPath, "Schedule4", "OnTimeStart", "") == "1")
            {
                if (ini12.INIRead(sPath, "Schedule1", "OnTimeStart", "") == "1" && DateTime.Compare(dt1, dt4) > 0)
                {
                    checkBoxTimer4.BackColor = System.Drawing.Color.DarkMagenta;
                    SavedLabel.Text = "Schedule4 Timer Error !";
                    Global.FormSchedule = false;
                }
                else if (ini12.INIRead(sPath, "Schedule2", "OnTimeStart", "") == "1" && DateTime.Compare(dt2, dt4) > 0)
                {
                    checkBoxTimer4.BackColor = System.Drawing.Color.DarkMagenta;
                    SavedLabel.Text = "Schedule4 Timer Error !";
                    Global.FormSchedule = false;
                }
                else if (ini12.INIRead(sPath, "Schedule3", "OnTimeStart", "") == "1" && DateTime.Compare(dt3, dt4) > 0)
                {
                    checkBoxTimer4.BackColor = System.Drawing.Color.DarkMagenta;
                    SavedLabel.Text = "Schedule4 Timer Error !";
                    Global.FormSchedule = false;
            ...
            #endregion
            #region Schedule5偵錯
            if (ini12.INIRead(sPath, "Schedule5", "OnTimeStart", "") == "1")
            {
                if (ini12.INIRead(sPath, "Schedule1", "OnTimeStart", "") == "1" && DateTime.Compare(dt1, dt5) > 0)
                {
                    checkBoxTimer5.BackColor = System.Drawing.Color.DarkMagenta;
                    SavedLabel.Text = "Schedule5 Timer Error !";
                    Global.FormSchedule = false;
                }
                else if (ini12.INIRead(sPath, "Schedule2", "OnTimeStart", "") == "1" && DateTime.Compare(dt2, dt5) > 0)
                {
                    checkBoxTimer5.BackColor = System.Drawing.Color.DarkMagenta;
                    SavedLabel.Text = "Schedule5 Timer Error !";
                    Global.FormSchedule = false;
                }
                else if (ini12.INIRead(sPath, "Schedule3", "OnTimeStart", "") == "1" && DateTime.Compare(dt3, dt5) > 0)
                {
                    checkBoxTimer5.BackColor = System.Drawing.Color.DarkMagenta;
                    SavedLabel.Text = "Schedule5 Timer Error !";
                    Global.FormSchedule = false;
                }
                else if (ini12.INIRead(sPath, "Schedule4", "OnTimeStart", "") == "1" && DateTime.Compare(dt4, dt5) > 0)
                {
                    checkBoxTimer5.BackColor = System.Drawing.Color.DarkMagenta;
                    SavedLabel.Text = "Schedule5 Timer Error !";
                    Global.FormSchedule = false;
        ...
        private void ComparePIC_CheckedChanged(object sender, EventArgs e)
        {
            if (CompareCheckBox.Checked == true)
            {
                ...
                // 寫入Import DadaBase啟動
                ini12.INIWrite(sPath, "Record", "CompareChoose", "1");
            }
            else
            {
                // 設定INI檔路徑
        ...
        private void checkBoxTimer1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                ini12.INIWrite(sPath, "Schedule1", "OnTimeStart", "1");
                dateTimePickerSch1.Enabled = true;
            }
            else
            {
        ...
        private void checkBoxTimer2_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                ini12.INIWrite(sPath, "Schedule2", "OnTimeStart", "1");
                dateTimePickerSch2.Enabled = true;
            }
            else
            {
        ...
        private void checkBoxTimer3_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                ini12.INIWrite(sPath, "Schedule3", "OnTimeStart", "1");
                dateTimePickerSch3.Enabled = true;
            }
            else
            {
        ...
        private void checkBoxTimer4_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                ini12.INIWrite(sPath, "Schedule4", "OnTimeStart", "1");
                dateTimePickerSch4.Enabled = true;
            }
            else
            {
        ...
        private void checkBoxTimer5_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                ini12.INIWrite(sPath, "Schedule5", "OnTimeStart", "1");
                dateTimePickerSch5.Enabled = true;
            }
            else
            {
        ...
        private void DifferenceBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                ini12.INIWrite(sPath, "Record", "CompareDifferent", "100");
            }
            else if (DifferenceBox.Text == "10%")
            {
                ini12.INIWrite(sPath, "Record", "CompareDifferent", "90");
            }
            else if (DifferenceBox.Text == "20%")
            {
                ini12.INIWrite(sPath, "Record", "CompareDifferent", "80");
            }
            else if (DifferenceBox.Text == "30%")
            {
                ini12.INIWrite(sPath, "Record", "CompareDifferent", "70");
            }
            else if (DifferenceBox.Text == "40%")
            {
                ini12.INIWrite(sPath, "Record", "CompareDifferent", "60");
            }
            else if (DifferenceBox.Text == "50%")
            {
                ini12.INIWrite(sPath, "Record", "CompareDifferent", "50");
            }
            else if (DifferenceBox.Text == "60%")
            {
                ini12.INIWrite(sPath, "Record", "CompareDifferent", "40");
            }
            else if (DifferenceBox.Text == "70%")
            {
                ini12.INIWrite(sPath, "Record", "CompareDifferent", "30");
            }
            else if (DifferenceBox.Text == "80%")
            {
                ini12.INIWrite(sPath, "Record", "CompareDifferent", "20");
            }
            else if (DifferenceBox.Text == "90%")
            {
                ini12.INIWrite(sPath, "Record", "CompareDifferent", "10");
            }
            else
            {
                ini12.INIWrite(sPath, "Record", "CompareDifferent", "0");
            }
        }
    }
}
