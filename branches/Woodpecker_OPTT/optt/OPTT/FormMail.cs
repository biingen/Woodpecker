...
namespace OPTT
{
    public partial class FormMail : Form
    {
        ...
        public void SendMail(List<string> MailList, string Subject, string Body)
        {
            ...
            */
            ...
            try
            {
                ...
                MySmtp.Credentials = new System.Net.NetworkCredential("OPTT.dqa@gmail.com", "Auo+1234");     //設定你的帳號密碼
        ...
        bool ConnectGMailTW()
        {
            ...
            //設定你的帳號密碼
            MySmtp.Credentials = new System.Net.NetworkCredential("OPTT.dqa@gmail.com", "Auo+1234");
            ...
            {
                //發送Email
                MySmtp.Send("'OPTT_Mail_System'<OPTT.dqa@gmail.com>", "'TP_DQA_Test'<tpdqatest@gmail.com>", "Gmail sent mail function test", "Gmail sent mail function test.");
