...
namespace OPTT
{
    public partial class Form1 : Form
    {
        ...
        */
        ...
        private void UsbCAN_Delay_UsbOnTimedEvent(object source, ElapsedEventArgs e)
        {
            ...
            //Replaced by another Debugging function//log_process("Canbus", canbus_log_text);
            UsbCAN_Count++;
        ...
        */
        ...
        {
            Console.WriteLine("[YFC]***      logA_recorder is invoked!!!     ***");
            if (ini12.INIRead(MainSettingPath, "Record", "Displayhex", "") == "1")
            {
                // if (SaveToLog == false)
                {
                ...
                if ((ch == 0x0A) || (ch == 0x0D) || (byteMessage_length_A >= byteMessage_max_Hex) /*|| (SaveToLog == true)*/)
                {
                    ...
                    //Replaced by another Debugging function//log_process("A", dataValue);
                    //Replaced by another Debugging function//log_process("All", dataValue);
        ...
        */
            ...
            for (int j = 1; j < GlobalData.Schedule_Loop + 1; j++)
            {
                ...
                lock (this)
                {
                    for (GlobalData.Scheduler_Row = 0; GlobalData.Scheduler_Row < DataGridView_Schedule.Rows.Count - 1; GlobalData.Scheduler_Row++)
                    {
                        ...
                        //logDumpping.LogCat(ca310_text, sch_log_text);         //
                        //logDumpping.LogCat(canbus_text, sch_log_text);        //log_process("Canbus", sch_log_text);
                        //logDumpping.LogCat(kline_text, sch_log_text);         //log_process("KlinePort", sch_log_text);
                        ...
                        else if (columns_command == "_HEX")
                        {
                            ...
                            if (GlobalData.portConfigGroup_C.checkedValue == true && columns_comport == "C")
                            {
                                         ...
                                         columns_function == "")
                                {
                                    ...
                                    serialPortC.WriteDataOut(Outputbytes, Outputbytes.Length);
                                }
                                DateTime dt = DateTime.Now;
        ...
        {   //related to button_SerialPort
            //serialPortA.OpenSerialPort("Port A");
        ...
        private void MyExportCamd()
        {
            string ab_num = label_LoopNumber_Value.Text,                                                        //自動編號
                        ...
                        ab_result = ini12.INIRead(MailPath, "Data Info", "Result", ""),                         //OPTT 測試結果
        ...
        */
        ...
        private void GP0_GP1_AC_ON()
        {
            ...
            {
                MessageBox.Show("OPTT is already running.", "GP0_GP1_AC_ON Error");
            }
            PowerState = true;
            pictureBox_AcPower.Image = Properties.Resources.ON;
        }
        ...
        private void GP2_GP3_USB_PC()
        {
            ...
            {
                MessageBox.Show("OPTT is already running.", "GP2_GP3_USB_PC Error");
            }
            USBState = true;
        }
        ...
        {
            /* will be added as a new driver layer code */
        }
        ...
        private void timer_ca310_Tick(object sender, EventArgs e)
        {
            if (ini12.INIRead(GlobalData.MainSettingPath, "Device", "CA310Exist", "") == "1")
            {
                ...
                catch (Exception)
                {
                    ...
                    pictureBox_ca310.Image = Properties.Resources.OFF;
                    MessageBox.Show("CA310 already disconnected, please restart the OPTT.", "CA310 Open Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
        }
    ...
    /* Below class has been moved to Program.cs */
